...
def build_report(df: pd.DataFrame):
    ...
    # Maps for name and qualification
    name_map, qual_map = {}, {}
    ...
    if student_enabled:
        ...
        # Ordered IDs and display labels
